const chat = {
    ...
    swapForm: function (direction) {
        ...
        if (direction) {
            ...
            console.log('Form switched to register mode.');
        }
        ...
        // (A2) SHOW SET NAME FORM
            ...
            console.log('Form switched to active mode.');
        }
    },
    ...
    userColor: '222222', //chat user own text color
    ...
    start: function () {
        ...
        console.log('trying connect to: ' + chat.host);
